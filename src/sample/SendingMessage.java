...
//ДАЛЕЕ ИДУТ ЭКСТРАКТНЫЕ ФУНКЦИИ
    ...
    private void outputAndUpdateMess(DataOutputStream out) {
        try {

            updateMessage("Server " + "(" + currentDate + ")" + ":" + Gui.sendingMessage.getText());
            out.writeUTF("Server " + "(" + currentDate + ")" + ":" + Gui.sendingMessage.getText());
